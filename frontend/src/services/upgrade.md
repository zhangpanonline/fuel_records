...
> [!CAUTION]
> **这是本 App 最重要的功能，绝不可被破坏。** App 通过 APK 直接安装到用户手机，无应用商店分发渠道。一旦自动更新失效，用户将永远停留在当前版本、无法获取修复或新功能、开发者无法主动触达用户。修改任何与此功能相关的代码前，必须停止并向用户说明修改原因和影响范围，获得明确同意后才能继续。关联文件清单见 [`TEST_CHECKLIST.md 自动更新保护章节`](file:///Users/zp/Code/fuel_records/TEST_CHECKLIST.md)。
