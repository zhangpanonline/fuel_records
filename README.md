...
- **个人记账**：追踪日常支出，支持自定义三级分类、旭日图/堆叠柱状图/饼图下钻等多维度可视化分析。
...
>
> **新增模块规格书**：[`EXPENSE_SPEC.md`](file:///Users/zp/Code/fuel_records/EXPENSE_SPEC.md) — 个人记账功能（自定义三级分类 + 旭日图/饼图下钻/堆叠柱状图多维度统计）
